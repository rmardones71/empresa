...
const routes = [
  ...
  { path: '/dashboard', name: 'Dashboard', element: Dashboard, permissionKey: 'dashboard.main' },
  ...
  { path: '/admin/roles', name: 'Roles', element: RolesManagement, permissionKey: 'admin.roles' },
  {
    path: '/admin/audit',
    name: 'Audit Logs',
