    ...
    >
      ...
      <CContainer fluid className="p-0">
        <CRow className="g-0 min-vh-100">
          ...
          <CCol
            lg={7}
            className="d-none d-lg-flex align-items-center justify-content-center position-relative overflow-hidden"
          >
            <div
            ...
            <div
              ...
              style={{
                ...
                color: '#ffffff',
                background:
                  'linear-gradient(180deg, rgba(35, 45, 61, 0.94) 0%, rgba(17, 18, 22, 0.98) 100%)',
            ...
            >
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background:
                      'linear-gradient(180deg, rgba(5, 15, 30, 0) 0%, rgba(5, 15, 30, 0.18) 100%)',
                  }}
                />
              </div>
